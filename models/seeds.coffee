...
if Meteor.isServer
	Meteor.startup ->
		...
		if SpecialAbilities.find().count() < 16
			...
			SpecialAbilities.insert unit_id: droneId, name: "armorTarget_drone", type: "defence", factor: "0.8", target_count: 1, states: ["pullweapon", "buff", "downweapon"]
			...
			SpecialAbilities.insert unit_id: sniperId, name: "defense_sniper", type: "attack", factor: "1.0", target_count: 1, states: ["pullweapon", "buff", "downweapon"]
			SpecialAbilities.insert unit_id: sniperId, name: "buffAccuracy_sniper", type: "improve", factor: "1.25", target_count: 1, states: ["pullweapon", "buff", "downweapon"]
			SpecialAbilities.insert unit_id: sniperId, name: "buffDamage_sniper", type: "improve", factor: "1.1667", target_count: 1, states: ["pullweapon", "buff", "downweapon"]
			SpecialAbilities.insert unit_id: sniperId, name: "buffCrit_sniper", type: "improve", factor: "1.25", target_count: 1, states: ["pullweapon", "buff", "downweapon"]
			...
			SpecialAbilities.insert unit_id: commanderId, name: "defense_commander", type: "attack", factor: "1.0", target_count: 1, states: ["pullweapon", "buff", "downweapon"]
			SpecialAbilities.insert unit_id: commanderId, name: "buffAllCrit_commander", type: "improve all", factor: "2", target_count: 5, states: ["pullweapon", "buff", "downweapon"]
			SpecialAbilities.insert unit_id: commanderId, name: "buffAllAccuracy_commander", type: "improve all", factor: "0.2", target_count: 5, states: ["pullweapon", "buff", "downweapon"]
			SpecialAbilities.insert unit_id: commanderId, name: "buffAllDamage_commander", type: "improve all", factor: "2", target_count: 5, states: ["pullweapon", "buff", "downweapon"]
			...
			SpecialAbilities.insert unit_id: specialistId, name: "defense_specialist", type: "attack", factor: "1.0", target_count: 1, states: ["pullweapon", "buff", "downweapon"]
